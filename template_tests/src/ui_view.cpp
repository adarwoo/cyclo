...
namespace { const char * const DOM = "view"; }
...
using namespace rtos::tick;
   ...
   const gfx_mono_color_t PROGMEM usb[] = {
      0x0,0xc0,0xe0,0xf0,0xf0,0xf0,0xe0,0xc0,0xc0,0xc0,0xc0,0xe0,0xf8,0xdc,0xcc,0xcc,0xcc,0xcc,0xcc,0xcc,0xde,0xde,0xcc,0xc0,0xc0,0xc0,0xc0,0xe0,0xc0,0x80,0x0,0x0,
      0x0,0x80,0x1,0x83,0x3,0x83,0x1,0x80,0x0,0x80,0x0,0x80,0x0,0x80,0x1,0x83,0xe,0x9c,0x18,0x98,0x18,0xbc,0x3c,0xbc,0x3c,0x80,0x0,0x83,0x1,0x80,0x0,0x80,
   };
   ...
   void UIView::draw_contact()
   {
      auto* switch_pixmap = model.contact_is_open() ?
   ...
   void UIView::draw_program_setup_dialog()
   {
      ...
      for (gfx_coord_t x=2; x<48; x+=2)
      {
         gfx_mono_draw_pixel(x, 15, GFX_PIXEL_SET); gfx_mono_draw_pixel(x+1, 15, GFX_PIXEL_CLR);
         gfx_mono_draw_pixel(x, 47, GFX_PIXEL_SET); gfx_mono_draw_pixel(x+1, 47, GFX_PIXEL_CLR);
      }
